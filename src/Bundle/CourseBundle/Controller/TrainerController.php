 ...
 */
class TrainerController implements SecuredControllerInterface, ClassResourceInterface
{
    ...
    {
        $command = new FindTrainerQuery($id, $this->getLocale($request));
    ...
    {
        $command = new ModifyTrainerCommand($id, $this->getLocale($request), $request->request->all());
    ...
    {
        return SprungbrettCourseAdmin::TRAINER_SECURITY_CONTEXT;
    }
