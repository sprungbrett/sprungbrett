...
import type {Schema, SchemaEntry, SchemaTypes} from 'sulu-admin-bundle/containers/Form/types';
import metadataStore from 'sulu-admin-bundle/containers/Form/stores/MetadataStore';

// TODO do not hardcode "template", use some kind of metadata instead
const TYPE = 'workflowStage';
